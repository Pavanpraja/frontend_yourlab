      ...
      <div className="w-[75%] mx-auto h-[85%] bg-white p-[2rem] border-x-[0.1rem] border-gray-200">
        ...
        <form className="font-bold flex flex-col gap-[1rem]" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-center">
            <button type="submit" className="text-[1.2rem] font-bold py-[0.5rem] px-[3rem] bg-[aqua] font-sans tracking-tighter" aria-required><Link href={"/appointmentsubmit"}><h1>SUMMIT</h1></Link></button>
          </div>
        </form>
      </div>
    </div>
